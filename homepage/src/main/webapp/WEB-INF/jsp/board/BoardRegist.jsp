...
<title>SunnyMusic 공지사항</title>
<!-- BBS Style -->
<link href="/asset/BBSTMP_0000000000001/style.css" rel="stylesheet"/>
<!-- 공통 style -->
<link href="/asset/LYTTMP_0000000000000/style.css" rel="stylesheet"/>
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
<script src="https://cdn.tiny.cloud/1/5bxewvre8lj183qv65b16gchs1qts0d8xntu7j1uogxfvjls/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
...
function regist(){
	...
	//에디터 내용 저장 붙인다고 끝이 아니고 db에도 저장되어하므로 아래 코드 필수 모든 에디터 공통사항 
